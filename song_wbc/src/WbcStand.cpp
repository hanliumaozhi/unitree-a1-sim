...
void callback(const song_msgs::MotorStatePtr& motor_state, const nav_msgs::OdometryConstPtr& odo_data)
{
...
int main(int argc, char** argv)
{
    ...
    message_filters::Subscriber<song_msgs::MotorState> state_sub(nh, "/a1_gazebo/A1_controller/state", 1);
    message_filters::Subscriber<nav_msgs::Odometry> odo_sub(nh, "/ground_truth/state", 1);
    message_filters::TimeSynchronizer<song_msgs::MotorState, nav_msgs::Odometry> sync(state_sub, odo_sub, 2);
